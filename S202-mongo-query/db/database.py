...
class Database:
    def __init__(self, database, collection):
        connectionString = "mongodb+srv://root:root@cluster0.fymm3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
    ...
    def spawnChanceGT(self, spawnNumber):
        response = self.collection.find(
            {"spawn_chance": {"$gt": spawnNumber}},
            {
                "name": 1,
                "spawn_chance" : 1,
                #"_id": 0
